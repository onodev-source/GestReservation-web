...
const Overview = () => {
  ...
  return (
    <>
      ...
      <ModalPreview visible={visibleModalPreview} onClose={() => setVisibleModalPreview(false)} gallery={gallery} title="Fleet - Travel shopping UI design kit"  figcaption="Elegant product mockup for your next project" download />
    </>
  );
};
