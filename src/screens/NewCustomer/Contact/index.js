...
const Contact = ({ className, product }) => {
    ...
    <Card className={cn(styles.card, className)} title="Contact" classTitle="title-green" >
      <div className={styles.description}>
        <div className={styles.group}>
          ...
          <Dropdown  className={cn(styles, styles.dropdown)}  label={"Operators"}  tooltip="Choose operator"  value={category} setValue={setCategory} options={optionsCategory} />
